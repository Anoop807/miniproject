...
if(isset($_POST['user_register']))
{
    ...
    //insert_quary
    $insert_query= "INSERT INTO `user_table` (user_name,user_email,user_password,user_ip,user_mobile) VALUES(' $user_username', ' $user_email', '$user_password', '$user_ip','$user_contact')";
